          ...
          <aside class="sidebar col-sm-3 col-xs-12 col-sm-pull-9">
            ...
            <div class="block shop-by-side">
              ...
              <div class="block-content">
                <p class="block-subtitle">Tùy chọn mua hàng</p>
                <div class="layered-Category">
                  <h2 class="saider-bar-title">Danh mục</h2>
                  <div class="layered-content">
                    <ul class="check-box-list">
                      <?php $tmp = 0; ?>
                      <?php foreach($data['allcategories'] as $cate):
                      if($tmp++ >=8) break; ?>
                      <li>
                          <input type="checkbox" class="input_category" data-id="<?=$cate->id?>"
                           id="type<?=$cate->id?>" name="jtvc">
                          <label for="type<?=$cate->id?>">
                          <span class="button"></span> <?=$cate->name?>
                          <span class="count">(<?=$cate->soluong?>)</span>
                        </label>
                      </li>
                      <?php endforeach ?>
                    </ul>
    ...
    <script>  
          $(document).ready(function() {
            var oldContent = $('.products-grid').html()
              $('.input_category').click(function(event) {
                /* Act on the event */
