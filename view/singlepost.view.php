        ...
        <div class="col-xs-12 col-sm-9">
          <div class="entry-detail">
            ...
            <div class="entry-photo">
              <figure><img src="public/source/images/blog-lg-img.jpg" alt="Blog"></figure>
            </div>
              ...
              <div id="related-posts" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col4 fadeInUp">
                  <div class="product-item">
                    <article class="entry">
                      <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img2.jpg" alt="Blog"> </a> </div>
                  ...
                  <div class="product-item">
                    <article class="entry">
                      <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img3.jpg" alt="Blog"> </a> </div>
                      <div class="entry-info">
                  ...
                  <div class="product-item">
                    <article class="entry">
                      <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img4.jpg" alt="Blog"> </a> </div>
                      <div class="entry-info">
                  ...
                  <div class="product-item">
                    <article class="entry">
                      <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img5.jpg" alt="Blog"> </a> </div>
                      <div class="entry-info">
                  ...
                  <div class="product-item">
                    <article class="entry">
                      <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img6.jpg" alt="Blog"> </a> </div>
                      <div class="entry-info">
                  ...
                  <div class="product-item">
                    <article class="entry">
                      <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img7.jpg" alt="Blog"> </a> </div>
                      <div class="entry-info">
                  ...
                  <div class="product-item">
                    <article class="entry">
                      <div class="entry-thumb image-hover2"> <a href="#"> <img src="public/source/images/blog-img1.jpg" alt="Blog"> </a> </div>
                      <div class="entry-info">
          ...
          <div class="single-box">
            ...
            <div class="comment-list">
              <ul>
                <li>
                  <div class="avartar"> <img src="public/source/images/avatar.png" alt="Avatar"> </div>
              ...
              <div class="layered">
                <div class="layered-content">
                  <ul class="blog-list-sidebar">
                    <li>
                      <div class="post-thumb"> <a href="#"><img src="public/source/images/blog-img1.jpg" alt="Blog"></a> </div>
                      <div class="post-info">
                        <h5 class="entry_title"><a href="#">Lorem ipsum dolor sit amet</a></h5>
                        <div class="post-meta"> <span class="date"><i class="fa fa-calendar">&nbsp;</i> 2014-08-05</span> <span class="comment-count"> <i class="fa fa-comment-o">&nbsp;</i> 8 </span> </div>
                      </div>
                    </li>
                    <li>
                      <div class="post-thumb"> <a href="#"><img src="public/source/images/blog-img2.jpg" alt="Blog"></a> </div>
                      <div class="post-info">
                        <h5 class="entry_title"><a href="#">Lorem ipsum dolor sit amet</a></h5>
                        <div class="post-meta"> <span class="date"><i class="fa fa-calendar">&nbsp;</i> 2014-08-05</span> <span class="comment-count"> <i class="fa fa-comment-o">&nbsp;</i> 5 </span> </div>
                      </div>
                    </li>
                    <li>
                      <div class="post-thumb"> <a href="#"><img src="public/source/images/blog-img3.jpg" alt="Blog"></a> </div>
                      <div class="post-info">
                        <h5 class="entry_title"><a href="#">Lorem ipsum dolor sit amet</a></h5>
                        <div class="post-meta"> <span class="date"><i class="fa fa-calendar">&nbsp;</i> 2014-08-05</span> <span class="comment-count"> <i class="fa fa-comment-o">&nbsp;</i> 1 </span> </div>
                      </div>
                    </li>
                  </ul>
                </div>
          ...
          <div class="single-img-add sidebar-add-slider wow fadeInUp">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active"> <img src="public/source/images/add-slide1.jpg" alt="slide1">
                ...
                <div class="item"> <img src="public/source/images/add-slide2.jpg" alt="slide2">
                  <div class="carousel-caption">
                    <h3><a href="single_product.html" title=" Sample Product">Smartwatch Collection</a></h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <a href="#" class="info">All Collection</a> </div>
                </div>
                <div class="item"> <img src="public/source/images/add-slide3.jpg" alt="slide3">
                  <div class="carousel-caption">
